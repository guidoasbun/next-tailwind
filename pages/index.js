...
export default function Home() {
    return (
        <div className={styles.container}>
            ...
            <div
                className="min-h-screen bg-gray-50 py-6 flex flex-col justify-center relative overflow-hidden sm:py-12">
                    ...
                    <div className="max-w-md mx-auto">
                        <div className="divide-y divide-gray-300/50">
                            ...
                            <div className="pt-8 text-base leading-7 font-semibold">
                                ...
                                <p>
                                    <a href="https://tailwindcss.com/docs" className="text-sky-500 hover:text-sky-600">Read
                                        the docs &rarr;</a>
                                </p>
                            </div>
                        </div>
